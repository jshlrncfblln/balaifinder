...
function Offers(){
    return (
        <div className="relative bg-black px-6 pt-16 pb-20 lg:px-8 lg:pt-24 lg:pb-28">
            <div className="relative mx-auto max-w-7xl">
                <div className="text-center">
                    <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">Looking For?</h2>
                    <p className="mx-auto mt-3 max-w-2xl text-xl text-gray-300 sm:mt-4">Trouble in finding your ideal house? This site offers different categories of property that suites in your taste.</p>
                </div>
                <div className="mx-auto mt-12 grid max-w-lg gap-5 lg:max-w-none lg:grid-cols-3">
                    <div className="flex flex-col overflow-hidden rounded-lg shadow-lg shadow-sky-400">
                        <div className="flex-shrink-0">
                            <img className="h-48 w-full object-cover" src="./src/assets/Landing-page-2.jpg" alt="" />
                        </div>
                        <div className="flex flex-1 flex-col justify-between bg-white p-6">
                            ...
                            <div className="mt-6 flex items-center">
                                <div className="flex-shrink-0">
                                    <button className="px-4 py-2 bg-sky-700 rounded-lg text-white hover:bg-sky-500">View More</button>
                                </div>
                            </div>
                        </div>
                    </div>
